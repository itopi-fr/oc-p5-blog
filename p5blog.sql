...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 02 mars 2023 à 13:16
...
INSERT INTO `file` (`id`, `title`, `url`, `ext`, `mime`, `size_bytes`) VALUES
...
(32, 1, '93747408c7260c1b6652c513ba3f16171abb39031feffd59dbd0dea5e5f029a8', '2023-03-01 11:06:44', 'password_change');
...
(1, 1, 'owner', 'owner', 'owner@test.fr', 'owner');
...
CREATE TABLE IF NOT EXISTS `user_owner_infos` (
  ...
  `catch_phrase` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
